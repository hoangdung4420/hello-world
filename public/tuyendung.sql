...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 26, 2017 lúc 04:28 PM
...
(8, 'youtobe', 'https://www.youtube.com/?gl=VN');
...
INSERT INTO `job_categories` (`id_jc`, `name`, `parent _id`) VALUES
(1, 'Xây dựng', 0),
(2, 'Xây dựng ', 1),
...
INSERT INTO `job_levels` (`id_jl`, `name`) VALUES
(1, 'Mới tốt nghiệp'),
(2, 'Nhân viên'),
(3, 'Trưởng phòng'),
...
--
ALTER TABLE `job_categories`
  MODIFY `id_jc` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
...
--
ALTER TABLE `list_jobs`
  MODIFY `id_lj` int(255) NOT NULL AUTO_INCREMENT;
